...
import InputWindow from "./editor/InputWindow";
...
function FileEditor({left, heights, mode, setMode, sentenceID, setSentenceID}: FileEditorProps) {
    ...
    // local state
    const [height, mainNav, fileNav, inputNav, inputFooterNav, outputNav, outputFooterNav] = heights;
                        ...
                        <Route path={`${match.path}/file/:fileId`}>
                            <div className="comp">
                                <FileEditor left={true}
                                            heights={[height, mainNav, fileNav, inputNav, inputFooterNav, outputNav, outputFooterNav]}
                                            mode={editorMode}
